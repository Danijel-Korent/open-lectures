		...
		<div x-data="{ sidebarIsOpen: false }" class="relative flex w-full flex-col md:flex-row">
			...
			<nav x-cloak
				...
				<div class="flex flex-col gap-2 overflow-y-auto pb-6 mt-4">
					...
					<a href="#"
						class="flex items-center rounded-xl gap-2 bg-blue-700/10 px-2 py-1.5 text-sm font-medium text-black underline-offset-2 focus-visible:underline focus:outline-none">
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
							class="size-5 shrink-0" aria-hidden="true">
							<path
			...
			<div class="h-svh w-full overflow-y-auto bg-white">
				<!-- top navbar  -->
				<nav class="sticky top-0 z-10 flex items-center justify-end border-b border-slate-300 bg-slate-100 px-4 py-2"
					...
					<!-- breadcrumbs  -->
					<!-- <nav class="hidden md:inline-block text-sm font-medium text-slate-700 dark:text-slate-300"
						aria-label="breadcrumb">
						<ol class="flex flex-wrap items-center gap-1">
							<li class="flex items-center gap-1">
								<a href="#" class="hover:text-black dark:hover:text-white">Dashboard</a>
					...
					<div x-data="{ userDropdownIsOpen: false }" class="relative"
						...
						<button type="button"
							...
							<div class="hidden md:flex flex-col">
								<span class="text-sm font-bold text-black">Alex Martinez</span>
