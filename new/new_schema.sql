...
--
-- Host: localhost:8889
-- Generation Time: Feb 11, 2025 at 11:06 AM
...
(1, 'Admin', 'admin@gmail.com', '$2y$10$Zh1Xq2jxmCgxTietQd8v9.4DxsXZUrlhZA8l4zpP0KE932rPGf0YS', '2024-12-08 02:52:14');
...
CREATE TABLE `courses` (
  ...
  `n_lectures` int(11) DEFAULT NULL,
  ...
  `lecturerId` bigint(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `courses` (`id`, `name`, `language`, `year`, `n_lectures`, `t_duration`, `course_code`, `description`, `link_1`, `link_2`, `image`, `universityId`, `categoryId`, `lecturerId`) VALUES
...
INSERT INTO `institutions` (`id`, `name`, `country`, `city`, `u_image`) VALUES
...
CREATE TABLE `lecturers` (
  ...
  `l_image` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `lecturers` (`id`, `firstName`, `lastName`, `l_image`) VALUES
...
ALTER TABLE `courses`
  ADD PRIMARY KEY (`id`);
ALTER TABLE `courses` ADD FULLTEXT KEY `name_idx` (`name`);
ALTER TABLE `courses` ADD FULLTEXT KEY `desc_idx` (`description`);
